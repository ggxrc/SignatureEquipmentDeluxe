...
{
    /// <summary>
    /// Configurações de Eventos e Multiplicadores
    /// Controla bônus de XP durante eventos do jogo
    /// </summary>
    ...
    public class EventsConfig : ModConfig
    {
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.AntiFarmHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.BossPreHardmodeHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.BossHardmodeHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.MoonEventsHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.InvasionEventsHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.TimeEventsHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.WeatherEventsHeader")]
        ...
        [Header("$Mods.SignatureEquipmentDeluxe.Config.EventsConfig.SpecialEventsHeader")]
