...
namespace SignatureEquipmentDeluxe.Common.Players
{
    public class SignaturePlayer : ModPlayer
    {
        ...
        /// <summary>
        /// Detecta tecla ESC para cancelar seleção de runas
        /// </summary>
        public override void ProcessTriggers(TriggersSet triggersSet)
        {
            // Verifica se pressionou ESC (via IsKeyDown ou qualquer outro método)
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (heldItem != null && !heldItem.IsAir)
            {
                ...
                if (globalItem != null && globalItem.CanGainExperience(heldItem))
                {
                    ...
                    // Aplica efeitos elementais das runas
                    Systems.RuneElementalEffects.ApplyElementalDoT(target, Player, heldItem, damageDone);
