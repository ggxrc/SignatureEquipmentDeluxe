...
namespace Progression.Common.Visual
{
    /// <summary>
    ...
    public class ProjectileHitEffect
    {
        ...
        /// Spawna partículas de impacto
        /// </summary>
        private static void SpawnImpactParticles(Vector2 position, Color color, HitEffectStyle style, Progression.Common.Configs.ClientConfig config, int damage, DamageClass damageType)
        {
